sap.ui.jsview("sap.stream.detailPage.timeSeriesAnalysis.barChart", {

	getControllerName : function() {
		return "sap.stream.detailPage.timeSeriesAnalysis.barChart";
	},
	...
	createContent : function(oController) {
		...
		oController.olineChart = new sap.viz.ui5.Bar ({
			width : "100%",
			height : "400px",
			legendGroup: legend,
			plotArea : {
