sap.ui.controller("sap.stream.detailPage.demographicAnalysis.chartView.mapright", {
	...
	onAfterRendering: function() {
		 ...
		 var that = this;
	        this.map = new nokia.maps.map.Display(document.getElementById("demoRightMapContainer"), {
	        ...
	        $(".demoRightMapContainer").bind("mousedown", function(event) {
